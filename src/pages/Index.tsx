        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="relative mx-auto w-full max-w-[320px]">
              <div className="absolute inset-0 rounded-[40px] bg-gradient-to-br from-steppy-primary to-steppy-secondary blur-xl opacity-20 animate-pulse-ring" />
              
              <div className="relative overflow-hidden rounded-[40px] border-8 border-gray-900 bg-gray-900 shadow-xl">
                <div className="relative bg-white aspect-[9/19]">
                  {/* Here we'd use Lottie player for animation */}
                  <img 
                    src="/lovable-uploads/67dbff06-1948-430e-b206-167a83f801ee.png" 
                  ...
                  <motion.div 
                    className="absolute top-[35%] right-[20%] h-16 w-16 bg-green-500/20 rounded-full"
                    animate={{ 
                      scale: [1, 1.2, 1],
                      opacity: [0.2, 0.3, 0.2],
                    }}
                  ...
                  <motion.div 
                    className="absolute top-[25%] left-[15%] h-12 w-12 bg-purple-500/20 rounded-full"
                    animate={{ 
                      scale: [1, 1.3, 1],
                      opacity: [0.2, 0.1, 0.2],
                    }}
              ...
              {/* Floating elements */}
              <motion.div 
                className="absolute -top-6 -right-6 bg-white rounded-2xl shadow-lg p-3 flex items-center"
                animate={{ y: [0, -8, 0] }}
              ...
              <motion.div 
                className="absolute -bottom-4 -left-6 bg-white rounded-2xl shadow-lg p-3"
                animate={{ y: [0, 8, 0] }}
                transition={{ duration: 3, repeat: Infinity }}
              >
                <p className="text-xs font-medium">Today's Steps</p>
                <div className="flex items-center">
                  <p className="text-sm font-bold">8,247</p>
                  <ArrowDownRight size={14} className="text-red-500 ml-1" />
                </div>
              </motion.div>
            </div>
          </motion.div>
